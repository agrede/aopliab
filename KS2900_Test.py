...
bias_start = 0.0;   bias_stop = 5;   bias_step = .1;
voltages = np.arange(bias_start, bias_stop + bias_step, bias_step)
current_limit = 1.515
photocurrent_limit = 0.1
integ_time = 8E-6
pulse_width = 150E-6
pulse_period = 10E-3
...
#liv = smu.dc_internal_LIV(bias_start, bias_stop, bias_step, current_limit, photocurrent_limit, compliance_protection, integ_time, timeout)


liv = smu.pulsed_internal_LIV(bias_start, bias_stop, bias_step, current_limit, 
                              photocurrent_limit, compliance_protection, integ_time, pulse_width,
...
#[x,y,z] = livmeasure_2900(voltages, current_limit, photocurrent_limit, integ_time, addr)
