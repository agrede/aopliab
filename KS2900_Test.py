...
pulse_bias_start = -2;   pulse_bias_stop = 6;   pulse_bias_step = .1;
...
liv = iv.pulsed_livmeasure_2900_transamp(voltages, 
     ...
     pulse_integ_time, pulse_width, pulse_period, 
     timeout, addr); 
fname = ('S%2dD%2d_LIV%2d - Pulsed Sweep %2.2fV to %2.2fV - %3.0e ApV TA gain.txt' %(sample, device, count, pulse_bias_start, pulse_bias_stop, transamp_gain))


fpath = 'C:/Users/jspri/Dropbox/Jared/Data/2016_7-21 - Perovskite Testing/S01D02/'
